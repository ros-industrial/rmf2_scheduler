...
__all__: list[str] = ['ChangeAction', 'Duration', 'Edge', 'Event', 'Graph', 'Node', 'Occurrence', 'Process', 'ScheduleAction', 'ScheduleChangeRecord', 'Series', 'Task', 'Time', 'TimeWindow', 'action_type', 'record_action_type', 'record_data_type']
class ChangeAction:
    """
